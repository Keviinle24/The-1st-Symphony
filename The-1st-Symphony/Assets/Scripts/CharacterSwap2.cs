...
public class CharacterSwap2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 1; i < characters.Length; i++)
        {
            ...
            characters[i].GetComponent<move>().SetMovementEnabled(false);
    ...
    void SwitchCharacter(int direction = 1)
    {
        ...
        characters[activeCharacterIndex].GetComponent<move>().SetMovementEnabled(false);
        ...
        // characters[activeCharacterIndex].GetComponent<Walk_mechanic>().SetMovementEnabled(true);
          characters[activeCharacterIndex].GetComponent<move>().SetMovementEnabled(true);
    ...
    public void AddPlayer(GameObject newPlayer)
    {
      ...
      //  characters[characters.Length - 1].GetComponent<Walk_mechanic>().SetMovementEnabled(false);
                characters[characters.Length - 1].GetComponent<move>().SetMovementEnabled(false);
